...
# Supported commands:    2018 al for Blt no longer works
#_busyCommand   = '::Rbc::busy'
#_vectorCommand = '::Rbc::vector'
#_graphCommand  = '::Rbc::graph'
#_testCommand   = '::Rbc::*'
#_chartCommand  = '::Rbc::stripchart'
#_tabsetCommand = '::Rbc::tabset'
...
def _checkForBlt(window):
    ...
    try:
	# July 2018 al   window.tk.call('package', 'require', 'BLT')
	window.tk.call('package', 'require', 'BLT')
    except Tkinter.TclError:
	# Another way to try to dynamically load blt:
	print " package require BLT failed"
	try:
	    # July 2018 al   window.tk.call('load', '', 'Blt')
	    window.tk.call('load', '', 'Blt')
	except Tkinter.TclError:
	    print " Load Blt failed"
	    pass
