...
class IOBinding:
    ...
    def loadfile(self, filename):
        try:
            ...
            tkinter.messagebox.showerror("I/O Error", str(msg), parent=self.text)
            return False
    ...
    def writefile(self, filename):
        ...
        try:
            ...
            tkinter.messagebox.showerror("I/O Error", str(msg),
                                   parent=self.text)
            return False
    ...
    def print_window(self, event):
        ...
        if printPlatform:  #we can try to print for this platform
            ...
            if output:
                ...
                tkinter.messagebox.showerror("Print status", output, parent=self.text)
        else:  #no printing for this platform
            message = "Printing is not enabled for this platform: %s" % platform
            tkinter.messagebox.showinfo("Print status", message, parent=self.text)
        if tempfilename:
            os.unlink(tempfilename)
        return "break"
    ...
    def askopenfile(self):
        ...
        if not self.opendialog:
            self.opendialog = tkinter.filedialog.Open(parent=self.text,
    ...
    def asksavefile(self):
        ...
        if not self.savedialog:
            self.savedialog = tkinter.filedialog.SaveAs(
                    parent=self.text,
                    filetypes=self.filetypes,
