...
class MyGnuplotPlot:
    ...
    def __init__(self, master, args):
        ...
        f3 = tkinter.Frame(self.topwindow, relief='raised', borderwidth=1)
        ...
        self.sf.pack(side='top', fill='top', expand=1, padx=5, pady=5, anchor='center')
