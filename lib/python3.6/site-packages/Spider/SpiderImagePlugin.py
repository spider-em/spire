...
#
# History:
# 2025-06-27    updated to Python 3.6
...
#
# SPIDER home page:
# https://spider-em.github.io/SPIDER/docs/spider.html
#
# Details about the SPIDER image format:
# https://spider-em.github.io/SPIDER/docs/image_doc.html
...
class SpiderImageFile(ImageFile.ImageFile):
    ...
    def _open(self):
        ...
        try:
            self.imgsize = int(h[12]), int(h[2])  # size in pixels (width, height)
        except AttributeError:
            import inspect ; print(f"{os.path.splitext( os.path.basename(__file__) )[0]}:116:\t{inspect.stack()[0][3]}() called by {inspect.stack()[1][3]}()")
            traceback.print_exc()
            print(f"  h: {type(h)} ({len(h)}): {h[12]}, {h[2]}")
            print()
            exit()
        ...
        self.tile = [("raw", (0, 0) + self.imgsize, offset,
                    (self.rawmode, 0, 1))]
