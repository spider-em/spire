...
class ExtApplications:
    ...
    def makeAppDisplay(self):
        ...
        for ext in keys:
            ...
            sv1.set(ext)
            sv2.set(app)
            e1 = tkinter.Entry(fr, textvariable=sv1)
            e2 = tkinter.Entry(fr, textvariable=sv2)
    ...
    def addButtons(self):
        fr = self.masterFrame
        bnew = tkinter.Button(fr, text='New', command=self.new)
        bnew.pack(side='left', padx=4, pady=4)
        snew = tkinter.Button(fr, text='Save', command=self.save)
    ...
    def new(self):
        ...
        sv1 = tkinter.StringVar()
        sv2 = tkinter.StringVar()
        e1 = tkinter.Entry(self.frame, textvariable=sv1)
        e2 = tkinter.Entry(self.frame, textvariable=sv2)
        self.textVarList.append( [sv1,sv2] )
