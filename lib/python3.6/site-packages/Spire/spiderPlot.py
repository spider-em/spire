...
from . import GG   # needed only for instance destruction
...
def hasGnuplot():
    try:
        Gnuplot.__version__  #### previously assigned to 'f'
        return 1
    except:
        return 0
...
class MyGnuplotPlot:
    ...
    def __init__(self, master, args):
        ...
        f3 = tkinter.Frame(self.w, relief=tkinter.RAISED, borderwidth=1)
        ...
        f5 = tkinter.Frame(self.w, relief=tkinter.RAISED, borderwidth=1)
        Addbut = tkinter.Button(f5, text='Add', command=self.add_data)
        Addbut.grid(row=0, column=0, padx=5, pady=5)
        Clearbut = tkinter.Button(f5, text='Clear', command=self.clear)
        Clearbut.grid(row=0, column=1, padx=5, pady=5)
        Savebut = tkinter.Button(f5, text='Save', command=self.save)
        Savebut.grid(row=0, column=2, padx=5, pady=5)
        Quitbut = tkinter.Button(f5, text='Close', command=self.remove)
