...
class projectViewer:
    ...
    def addBatchButton(self, br):
        ...
        ###import inspect ; print(f"spiderView:227:\t{inspect.stack()[0][3]}() called by {inspect.stack()[1][3]}()")
        space = "  "
        id = br[0]
        batdir = br[1]
    ...
    def fillBatchPane(self, data):
        ###import inspect ; print(f"spiderView:252:\t{inspect.stack()[0][3]}() called by {inspect.stack()[1][3]}()")
        W = []
        for h in self.headers:
            W.append(len(h))
