...
class execWindow:
    ...
    def update_queue(self):
        ##import inspect ; print(f"{os.path.splitext( os.path.basename(__file__) )[0]}:177:\t{inspect.stack()[0][3]}() called by {inspect.stack()[1][3]}()")
        ##if inspect.stack()[1][3] == 'callit' : print(f"{os.path.splitext( os.path.basename(__file__) )[0]}:178:{inspect.stack()[0][3]}\tcallit: {callit.__file__}")
        try:
            while 1:
