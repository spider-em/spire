...
def listicons(root):
    global icondict  # I don't know what this does?
...
def makeIcons():
    ...
    image = tkinter.PhotoImage(format='gif',data=
...
class TreeNode:
    ...
    def __init__(self, canvas, parent, item):
        ...
        self.iconimages = {} # cache of tkinter.PhotoImage instances for icons
    ...
    def drawtext(self):
        ...
        try:
            ...
            self.label = tkinter.Label(self.canvas, text=text, font=self.canvas.font,
                               bd=0, padx=2, pady=2)
        if self.selected:
...
class ScrolledCanvas:
    ...
    def zoom_height(self, event):
        tkinter.ZoomHeight.zoom_height(self.master)
        return "break"
...
class TreeViewer:
    ...
    def __init__(self, master, icondict, directory=None):
        ...
        self.displayProg = tkinter.StringVar()
    ...
    def saveFile(self):
        ...
        if not messagebox.askyesno("Are you sure?", "write window contents to %s?" % filename):
            return
        try:
    ...
    def getOptions(self):
        self.optwin = tkinter.Toplevel(self.master)
        self.optwin.title('Options')
        f1 = tkinter.Frame(self.optwin)
        ...
        txtlbl2 = tkinter.Label(f1, text="bytes")
        ...
        dirlbl2 = tkinter.Label(f1, text="bytes")
        ...
        ok = tkinter.Button(self.optwin, text='Done', command=self.setOptions)
...
def startTree(win=None, ddir=None):
    ...
    icondict = makeIcons()
    TreeViewer(win, icondict, ddir)  #### previosly assigned to 'tv'
