...
class DialogWindow(spiderClasses.scrolledForm):
    ...
    def addProgButton(self, frame, button, row):
        ...
        cmdlist = button[2]
        # the Label
        tkinter.Label(frame, text=label).grid(row=row, column=0, sticky='e', padx=5, pady=5)
        # the Run button
...
class ButtonFrame:
    ...
    def __init__(self, btn, parent):
        ...
        tkinter.Entry(fr, textvariable=self.label).grid(row=0,column=1, sticky='ew')
        l2 = tkinter.Label(fr,text="Button text: ")
        l2.grid(row=1,column=0, sticky='w')
        tkinter.Entry(fr, textvariable=self.btntxt).grid(row=1,column=1, sticky='ew')
        l3 = tkinter.Label(fr,text="Program(s): ")
        l3.grid(row=2,column=0, sticky='w')
        tkinter.Entry(fr, textvariable=self.progs).grid(row=2,column=1, sticky='ew')
