...
class ProjectDatabase:
    ...
    def Keys(self):
        keys = []
        print("spiderClasses:166: Keys calling openDatabase")
        if self.openDatabase():
    ...
    def get(self, key='Project'):
        ...
        #print("spiderClasses:174: get calling openDatabase")
        #opendb= self.openDatabase()
        #print("spiderClasses:get:176:opendb:", opendb)
        #print("spiderClasses:177: get calling openDatabase")
        if self.openDatabase():
            ###print("spiderClasses:179: openDatabase returned: 1")
    ...
    def put(self, key, object):
        ...
        if key not in pc:
            ...
            return
        ###print("spiderClasses:193: put calling openDatabase")
    ...
    def BatchRun(self, id):
        ...
        print("spiderClasses:205: BatchRun calling openDatabase")
        if self.openDatabase():
