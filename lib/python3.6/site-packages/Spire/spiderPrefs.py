...
class UserPreferences:
    ...
    def makeMenuBar(self):
        ...
        self.useBalloonVar = tkinter.IntVar()
        self.useDatabaseVar = tkinter.IntVar()
        self.saveResultsVar = tkinter.IntVar()
        self.delAskVar = tkinter.IntVar()
        self.logfileVar = tkinter.IntVar()
        self.priorVar  = tkinter.IntVar()
        self.filenumVar  = tkinter.IntVar()
        ###self.jwebVar = tkinter.IntVar()
    ...
    def makeEntries(self):
        frame = self.frame
        self.maxResultVar = tkinter.StringVar()
        self.maxDisplayVar = tkinter.IntVar()
        #self.displayprogVar = tkinter.StringVar()
    ...
    def makeSession(self):
        ...
        exlab = tkinter.Label(gr, text="The local host is %s" % spiderUtils.gethostname())
    ...
    def reset(self):
        ...
        spiderGUtils.readUserPrefs()
        self.setValues()

    def default(self):
        " reset GG.interface to system defaults "
        old_prefs= GG.prefs  # there isn't a way to useLocalPrefsFile from the GUI yet, so use preexisting setting
        GG.interface = GG.SysInterface()  # new instance with defaults
        GG.prefs = GG.interface.user
        GG.sysprefs = GG.interface.system

        if old_prefs.useLocalPrefsFile == 0 or not spiderUtils.hasProject():
