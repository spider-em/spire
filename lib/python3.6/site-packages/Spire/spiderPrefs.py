...
class UserPreferences:
    ...
    def default(self):
        ...
        ###import inspect ; print(f"{os.path.splitext( os.path.basename(__file__) )[0]}:259:\t{inspect.stack()[0][3]}() called by {inspect.stack()[2][3]}()")
        ...
        if old_prefs.useLocalPrefsFile == 0 or not hasProject():
