...
TCL_EXTRA_CFLAGS='-fmessage-length=0 -grecord-gcc-switches -O2 -Wall -D_FORTIFY_SOURCE=2 -fstack-protector -funwind-tables -fasynchronous-unwind-tables -g -pipe '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/abuild/rpmbuild/BUILD/tcl8.6.3/unix -ltcl8.6'
...
# compiled.
TCL_SRC_DIR='/home/abuild/rpmbuild/BUILD/tcl8.6.3'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/abuild/rpmbuild/BUILD/tcl8.6.3/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/usr/lib64 -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/abuild/rpmbuild/BUILD/tcl8.6.3/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/usr/lib64/libtclstub8.6.a'
